...
describe('IPL module', () => {
  ...
  describe('Extra runs conceeded per team for year, getExtraRunsPerTeamForYear', () => {
    ...
    test('should return an object', () => {
      expect(getExtraRunsPerTeamForYear(deliveryData,matchesData)).toBeDefined()
      expect(typeof getExtraRunsPerTeamForYear(deliveryData,matchesData)).toEqual('object')
      expect(getExtraRunsPerTeamForYear(deliveryData,matchesData)).toEqual(expectedResult2)
    })
  })
  describe('Economical bowlers for year, getEconomicalBowlersForYear', () => {
    ...
    test('should return an object', () => {
      expect(getEconomicalBowlersForYear(deliveryData,matchesData)).toBeDefined()
      expect(typeof getEconomicalBowlersForYear(deliveryData,matchesData)).toEqual('object')
      expect(getEconomicalBowlersForYear(deliveryData,matchesData)).toEqual(expectedResult3)
    })
  })
})
